...
Текущая версия проекта — **0.6.1**. Готовые ZIP содержат **Node.js 24.21.0** и библиотеки: после распаковки установка зависимостей не требуется. Для разработки из исходников используются тот же Node и npm **11.x**.
