...
Аудит текущих исходников: 12 сентября 2026 года. Это план следующих изменений; перечисленные ниже переносы модулей, индексы и контракты ещё не реализованы. Порядок проверки интерфейса описан в [руководстве по плейтесту](playtest.md).
